...
def process_choice(choice):
    if choice == '0':
        ...
        print_sum_transactions('Date', trans)
    elif choice == '8':
        trans = transaction.summarize_by_month()
        print_sum_transactions('Month', trans)
    elif choice == '9':
        trans = transaction.summarize_by_year()
        print_sum_transactions('Year', trans)
    elif choice == '10':
...
# Author: Tony Qiu
def print_sum_transaction(trans):
    print("%-15s %-10s"
...
# Author: Tony Qiu
def print_sum_transactions(sum_by, trans_ls):
    print("%-15s %-10s"
          % (sum_by, "total_amount"))
    print('-' * 30)
    for trans in trans_ls:
        print_sum_transaction(trans)
